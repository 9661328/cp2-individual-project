...
public class PeriodicTable extends PApplet implements WindowListener {
	...
	String[] elementKeys = { "summary", "appearance", "atomic_mass", "boil", "melt", "category", "density",
		"discovered_by", "named_by", "number", "period", "phase", "source", "spectral_img", "symbol", "xpos",
		"ypos", "molar_heat", "electron_configuration", "electron_configuration_semantic", "electron_affinity",
