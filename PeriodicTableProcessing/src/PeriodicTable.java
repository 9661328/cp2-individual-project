...
//	}
	...
	String[] sortOptions = { "Atomic number", "Atomic mass", "Melting point", "Boiling point", "Density",
	...
	enter.addActionListener(new ActionListener() {
		...
		selectedSort = j.getItemAt(j.getSelectedIndex());
		
		switch (selectedSort) {
		case "Atomic number":
		    System.out.println(Element.sort(elements, "Alphabetically"));
		    break;
		case "Atomic mass":
		    Element.sort(elements, "Atomic mass");
		    break;
	...
	JTable textArea = new JTable(2, 2);
	JScrollPane scrollPane = new JScrollPane(textArea);
