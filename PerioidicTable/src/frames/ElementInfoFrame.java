...
public class ElementInfoFrame extends JFrame implements WindowListener {
    ...
    public ElementInfoFrame(ArrayList<LinkedHashMap<String, Object>> elements, ArrayList<ElementComponent> components, ElementComponent e) {
	try {
